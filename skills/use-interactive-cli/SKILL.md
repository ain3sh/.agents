---
name: use-interactive-cli
description: Reference for using `zellij` to create and manipulate terminal sessions for interactive CLIs. Use when the user mentions controlling any terminal apps that are interactive/visual.
---
